      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Alok Pandey</h2><p>CE084 <a href="https://github.com/alokpandey11" target="_blank">@alokpandey</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://twitter.com/alokpandey" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://github.com/alokpandey11" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="https://www.linkedin.com/in/alokpandey11" target="_blank"><i class="icofont-linkedin" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
